var _labelsDatas = {
	"about_titre" : {
		"fr" : "« Mieux trier à Nantes », v. 1.16"
	},
	"about" : {
		"fr" : "Application android (gratuite) et site mieuxtrieranantes.fr pour aider les habitants de Nantes Métropole à trier. "
				...
				+ " <A HREF='https://plus.google.com/115672613214762676111/posts' ><IMG SRC='resources/icons/googleplus.png' HEIGHT='18px' style='vertical-align:middle;'/></A> "
				+ " <A HREF='https://framasphere.org/people/b0e79dd0547701326e712a0000053625' ><IMG SRC='resources/icons/framasphere.png' HEIGHT='18px' style='vertical-align:middle;'/></A> "
				+ "<IMG SRC='resources/icons/twitter.png' HEIGHT='18px' style='vertical-align:middle;'/><font size='1'>@MieuxTrierANant</font><br/>"
		...
		"en" : "Android application (free) and mieuxtrieranantes.fr website to help inhabitants of Nantes Métropole to sort. "
				...
				+ "Contacts : <i><a href='mailto:mieuxtrieranantes@gmail.com'><font size='2'>mieuxtrieranantes@gmail.com</font></a></i><br/>"
				+ "<br/>"
				+ "Friends : <IMG SRC='resources/images/images_non_libres/logo_les_boites_vertes_rogne_mini.png' HEIGHT='22px' style='vertical-align:middle;'/>&nbsp;&nbsp;<A HREF='http://lesboitesvertes.fr/' TARGET=_blank title='Association les boîtes vertes (Baludik, PlusDeVers)'>les boîtes vertes</A>"
	}
};
