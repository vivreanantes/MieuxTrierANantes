...
copy C:\dev\github-repositories\MieuxTrierANantes\cordova\platforms\android\ant-build\CordovaApp-debug.apk C:\dev\github-repositories\opendata\VivreANantes\build\VivreANantes\testing
pause