var _infosDatas = [{
	"code" : "fiche_aremacs",
	"nom" : "Aremacs",
	"descr" : "<src img='resources/images/images_non_libres/aremacs_mini.png' width='150px' /><br/>Aremacs est une association qui intervient lors des grands évènements pour le tri des déchets. <br/>Ils posent notamment des poubelles de tri pour les grands événements nantais, et veillent lors de toute la soirée à la bonne utilisation (et à vider) ces poubelles. <br/><br/>Son antenne sur Nantes est très active et de nombreux évènements sont couverts : le feu d'artifice, les rendez-vous de l'Erdre...<br/><br/>Adresse : 27 rue de Strasbourg, 44000 NANTES<br/>Tél : 02 51 82 37 23<br/>nantes@aremacs.com<br/><br/>Plus d'infos sur <a target=_blank href='http://www.aremacs.com/' >http://www.aremacs.com/</a>",
	"bouton" : "fiche",
	"image" : "images_non_libres/aremacs_mini.png",
	"mots_cles" : "aremacs"
}, {
	"code" : "fiche_bacjaune",
	...
	"descr" : "<img src='resources/images/encombrant.jpg' align='right' /><br/>Pour les logements verticaux (appartement...) les encombrants sont récupérés à jour fixe dans la semaine (affiché en général en bas de l'immeuble).<br/>Pour les logements pavillonnaires (maisons...) le ramassage se fait sur rendez-vous à prendre par téléphone (numéros ci-dessous).<br/><br/>Pour Nantes, <b>0800 344 000</b> ('Allo Propreté' de 8h à 17h du lundi au samedi, appel gratuit depuis un téléphone fixe).<br/><br/>Pour Couëron, Indre, Saint-Herblain <b>0 800 00 70 76</b> (de 8h à 18h du lundi au samedi, appel gratuit depuis un téléphone fixe)<br/><br/>Pour Basse-Goulaine, Bouaye, Bouguenais, Brains, Carquefou, La Chapelle-sur-Erdre, La Montagne, Le Pellerin, Les Sorinières, Mauves-sur-Loire, Orvault, Rezé, Saint-Aignan-de-Grand-Lieu, Saint-Jean-de-Boiseau, Saint-Léger-les-Vignes, Saint-Sébastien-sur-Loire, Sainte-Luce-sur-Loire, Sautron, Thouaré-sur-Loire, Vertou <b>0 800 800 868</b>.<br/><img src='resources/images/encombrant2.jpg' align='right' />",
	"bouton" : "fiche",
	...
	"mots_cles" : "recuperer,sacs,jaunes,et,bleus"
}, {
	"code" : "fiche_acier",
	"nom" : "Recyclage acier",
