...
Ext.define('MieuxTrierANantes.view.home.HomeZone4', {
	...
	config : {
		...
		items : [
			{
				id : "homeZone4_1",
				xtype : "button",height : '80px', width : '22%', cls : 'boutons_panneau',
				...
				id : "homeZone4_4",
				xtype : "button",height : '80px', width : '22%', cls : 'boutons_panneau',
				tpl : "<center><font size='2'>Listing<br/>lieux</font><br/><img src='resources/images/application-vnd.ms-excel.png' height='50px' /></center>", data : { label:"", image : ""}
			},{
					flex : 1
				}]
	}
