rmdir /S /Q C:\dev\github-repositories\MieuxTrierANantes\build
...
C:\dev\tools\sencha-cmd-4.0.4.84\sencha --plain app package build C:\dev\github-repositories\MieuxTrierANantes\packager_MieuxTrierANantes.json
